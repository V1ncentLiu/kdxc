...
public enum MenuEnum {
     ...
     * 电销管理 - 电销中心
     */
    TEL_CENTER_PUBLICCUSTOMER("公共客户资源"), TEL_CENTER_INVALIDCUSTOMER("无效客户资源"), FAIL_CLUE_MANAGEMENT("失败资源列表"), OPT_RULE_MANAGEMENT("优化分配规则管理"), ASSIGN_LIMIT_MANAGEMENT("资源分配量管理"), MERCHANT_RULE_MANAGEMENT("商家规则管理"), NOT_OPT_RULE_MANAGEMENT("非优化分配规则管理"), NOT_AUTO_OPT_RULE_MANAGEMENT("非自动优化分配规则管理"), OPT_AUTO_RULE_MANAGEMENT("优化自动分配规则管理"), TRAFFIC_RULE_MANAGEMENT("话务分配规则管理"), USER_SCORE_RULE_MANAGEMENT("用户得分规则管理"),CLUE_SCORE_RULE_MANAGEMENT("资源得分规则管理"),
    /**
     * 总裁办
     *
     */
     ...
     * 资源管理
     */
    WAIT_DISTRIBUT_RESOURCE("待分发资源"), CLUE_TEMPLATE_MANAGEMENT("资源模板管理"), CLUE_RULE_REPORT("规则报表"), ABANDON("废弃池"),
    /**
     * 财务
     */
    ...
    OVERCOST_CONFIRM("超成本确认"), OVERCOST_REJECT("超成本驳回"), OVERCOST_APPLY(
            "超成本申请"), OVERCOST_SETTLEMENT("超成本已结算"),
    /**
     * 版本管理
     */
