...
public class ClueReleaseRecordController {
     ...
     *      一个电销总监，多个电销创业顾问
     * 电销副总：能够看见整个事业部的释放记录
     *      就是能够看见：当前组织 以及 当前组织的全部下属组织机构
     *
     *   当前释放记录中：没有组织机构。
     *      故而，查询，当前组织以及下属组织的全部人员
     *
     *
     *  下面方法：
     *      查询的是：当前组织下 包括 全部下属组织的 所有用户
     *
     * @return
     */
    private List allUser(){
        ...
        JSONResult<List<OrganizationDTO>> orgResult = organizationFeignClient.listDescenDantByParentId(organizationQueryDTO);
