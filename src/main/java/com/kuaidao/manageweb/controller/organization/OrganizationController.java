...
public class OrganizationController {
	...
	public JSONResult save(@Valid @RequestBody OrganizationAddAndUpdateDTO orgDTO, BindingResult result)
			throws Exception {
		if (result.hasErrors()) {
	...
	public JSONResult update(@Valid @RequestBody OrganizationAddAndUpdateDTO orgDTO, BindingResult result) {
		if (result.hasErrors()) {
			return CommonUtil.validateParam(result);
		}
		return organizationFeignClient.update(orgDTO);
	...
	@ResponseBody
	public JSONResult<PageBean<UserAndRoleRespDTO>> listOrgUserInfo(@Valid @RequestBody OrgUserReqDTO reqDTO,
