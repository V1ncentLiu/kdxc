...
@FeignClient(name = "aggregation-service-1", path = "/aggregation/assignrule/telemarketingAssignRule", fallback = TelemarketingAssignRuleFeignClient.HystrixClientFallback.class)
public interface TelemarketingAssignRuleFeignClient {
	...
	JSONResult<PageBean<TelemarketingAssignRuleDTO>> queryTeleAssignRulePage(TeleAssignRuleQueryDTO queryDTO);
