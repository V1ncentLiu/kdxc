 ...
 * @version V1.0
 */
@FeignClient(name = "aggregation-service-ff", path = "/aggregation/refundRebate",
...
public interface RefundRebateFeignClient {
    ...
    @Component
    static class HystrixClientFallback implements RefundRebateFeignClient {

        private static Logger logger = LoggerFactory.getLogger(RefundRebateFeignClient.class);
