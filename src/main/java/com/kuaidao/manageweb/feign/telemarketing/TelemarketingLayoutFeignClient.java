...
@FeignClient(name = "aggregation-service-1", path = "/aggregation/telemarketinglayout", fallback = TelemarketingLayoutFeignClient.HystrixClientFallback.class)

public interface TelemarketingLayoutFeignClient {

	@RequestMapping(method = RequestMethod.POST, value = "/getTelemarketingLayoutList")
	public JSONResult<PageBean<TelemarketingLayoutDTO>> getTelemarketingLayoutList(@RequestBody TelemarketingLayoutDTO queryDTO);
	@RequestMapping(method = RequestMethod.POST, value = "/findTelemarketingById")
	public JSONResult<TelemarketingLayoutDTO> findTelemarketingById(@RequestBody TelemarketingLayoutDTO queryDTO);
	...
	static class HystrixClientFallback implements TelemarketingLayoutFeignClient {
		...
		private static Logger logger = LoggerFactory.getLogger(TelemarketingLayoutFeignClient.class);
		...
		@Override
		public JSONResult<PageBean<TelemarketingLayoutDTO>> getTelemarketingLayoutList(TelemarketingLayoutDTO queryDTO) {
		...
		@Override
		public JSONResult<TelemarketingLayoutDTO> findTelemarketingById(TelemarketingLayoutDTO queryDTO) {
			// TODO Auto-generated method stub
