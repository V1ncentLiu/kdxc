 ...
 * @version V1.0
 */
@FeignClient(name = "account-service", path = "/account/merchantChargePreFerential", fallbackFactory = MerchantChargePreferentialFeignClient.HystrixClientFallback.class)
