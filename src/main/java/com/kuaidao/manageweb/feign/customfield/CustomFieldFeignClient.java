...
public interface CustomFieldFeignClient {
	...
	static class HystrixClientFallback implements CustomFieldFeignClient {
		...
		@Override
		public JSONResult<PageBean<CustomFieldMenuRespDTO>> listMenuPage(CustomFieldMenuQueryDTO queryDTO) {
		...
		@Override
		public JSONResult<PageBean<CustomFieldRespDTO>> listCustomFieldPage(CustomFieldQueryDTO queryDTO) {
