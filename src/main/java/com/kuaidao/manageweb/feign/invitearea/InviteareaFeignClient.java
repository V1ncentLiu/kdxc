...
@FeignClient(name = "business-config-service", path = "/businessConfig/invitearea",
        fallback = InviteareaFeignClient.HystrixClientFallback.class)
public interface InviteareaFeignClient {
    ...
    public JSONResult<PageBean<InviteAreaDTO>> inviteAreaListPage(
            @RequestBody InviteAreaDTO queryDTO);
    ...
    public JSONResult<List<InviteAreaDTO>> getInviteAreaListByIds(
            @RequestBody InviteAreaDTO queryDTO);
