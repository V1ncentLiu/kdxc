...
import com.kuaidao.aggregation.dto.cule.ClueAppiontmentDTO;
import com.kuaidao.aggregation.dto.cule.ClueDTO;
import com.kuaidao.aggregation.dto.cule.ClueFileDTO;
import com.kuaidao.aggregation.dto.cule.ClueQueryDTO;
import com.kuaidao.aggregation.dto.cule.CustomerClueDTO;
import com.kuaidao.aggregation.dto.cule.CustomerClueQueryDTO;
import com.kuaidao.aggregation.dto.cule.ReleaseClueDTO;
import com.kuaidao.aggregation.dto.cule.RepeatClueDTO;
import com.kuaidao.aggregation.dto.cule.RepeatClueQueryDTO;
import com.kuaidao.aggregation.dto.cule.RepeatClueSaveDTO;
import com.kuaidao.common.constant.SysErrorCodeEnum;
import com.kuaidao.common.entity.JSONResult;
import com.kuaidao.common.entity.PageBean;
import com.kuaidao.manageweb.feign.assignrule.InfoAssignFeignClient;

@FeignClient(name = "aggregation-service", path = "/aggregation/clue/myCustomer", fallback = MyCustomerFeignClient.HystrixClientFallback.class)
public interface MyCustomerFeignClient {
	...
	static class HystrixClientFallback implements MyCustomerFeignClient {
		...
		@Override
		public JSONResult<PageBean<CustomerClueDTO>> findTeleClueInfo(CustomerClueQueryDTO queryDTO) {
