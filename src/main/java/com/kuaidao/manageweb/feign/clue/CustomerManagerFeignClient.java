...
@FeignClient(name = "aggregation-service-001", path = "/aggregation/clue/customerManager", fallback = CustomerManagerFeignClient.HystrixClientFallback.class)
public interface CustomerManagerFeignClient {
	...
	static class HystrixClientFallback implements CustomerManagerFeignClient {
		...
		@Override
		public JSONResult<PageBean<CustomerManagerDTO>> findcustomerPage(CustomerManagerQueryDTO queryDTO) {
