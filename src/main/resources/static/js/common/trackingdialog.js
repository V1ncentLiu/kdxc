var trackingDialogTempate=
    ...
    +'<el-table-column prop="callTime" label="拨打时间" width="170" align="center"></el-table-column>'
    +'<el-table-column prop="customerStatusName" label="客户状态"  align="center"></el-table-column>'
    +'<el-table-column prop="isCall"  :formatter="formatIsCall" label="是否接通" align="center"></el-table-column>'
    ...
    +'<el-table-column prop="nextVisitTime" label="下次回访时间" width="170" align="center"></el-table-column>'
