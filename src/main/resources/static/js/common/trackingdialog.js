var trackingDialogTempate=
    ...
    +'<template>'
    +'<el-table :data="param.tableData"  style="width: 100%" tooltip-effect="light"  ref="releaseTable">'
    +'<el-table-column prop="xh" label="序号" width="80" type="index"  align="center" show-overflow-tooltip></el-table-column>'
    ...
    +'<el-table-column prop="isCall"  :formatter="formatIsCall" label="是否接通" align="center" show-overflow-tooltip></el-table-column>'
